...
*/
  ...
  var B = window,
    ...
    F = function (a, b) {
      D.addEventListener
        ...
        : D.attachEvent && D.attachEvent("on" + a, b);
    };
  var G = /:[0-9]+$/,
    J = function (a, b) {
      b && (b = String(b).toLowerCase());
      if ("protocol" === b || "port" === b)
        a.protocol = H(a.protocol) || H(B.location.protocol);
      "port" === b
        ? (a.port = String(
  ...
  function Y(a, b, c, d) {
    c.href &&
      ((a = V(a, b, c.href, void 0 === d ? !1 : d)), A.test(a) && (c.href = a));
  }
  function X(a, b, c) {
    if (c && c.action) {
      ...
      if ("get" === d) {
        ...
        "post" === d && ((a = V(a, b, c.action)), A.test(a) && (c.action = a));
    }
  }
  function ca(a) {
    try {
...
(function () {
  ...
  var p = /^(GTM|OPT)-[A-Z0-9]+$/,
    ...
    Ke = function (a, b, c, d) {
      ...
      if (e) {
        g = { id: b, type: e, B: c.dataLayer || "dataLayer", G: !1 };
        var ca = void 0;
        a.get("&gtm") == b && (g.G = !0);
        switch (e) {
          case 1:
